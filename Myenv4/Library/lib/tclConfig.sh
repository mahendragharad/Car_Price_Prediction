...
# installed.
TCL_PREFIX='C:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Projects/ALL_Data_SCIENCE_Projects/Car_Price_Prediction/Myenv4\Library\lib\tclstub86.lib'
